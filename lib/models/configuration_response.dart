class ConfigurationResponse {
  ...
  factory ConfigurationResponse.fromJson(Map<String, dynamic> json) {
    return ConfigurationResponse(
      ...
      versionCode: json['version_code'] is String ? json['version_code'] : (json['version_code'] != null ? json['version_code'].toString() : null),
      status: json["status"],
      pages: json['pages'] is List ? List<Pages>.from(json['pages'].map((x) => Pages.fromJson(x))) : [],
      isUserAuthorized: json["is_user_authorized"] ?? false,
      isDemoLogin: json["is_demo_login"] ?? true,
    );
  }
  ...
  Map<String, dynamic> toJson() {
    ...
    data["is_demo_login"] = this.isDemoLogin;
