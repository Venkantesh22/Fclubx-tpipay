...
class UserWalletHistoryResponse {
  ...
  UserWalletHistoryResponse({required this.pagination, this.data = const <WalletDataElement>[], this.availableBalance});
...
class WalletDataElement {
  ...
  factory WalletDataElement.fromJson(Map<String, dynamic> json) {
    ...
    try {
      final dynamic raw = json['activity_data'];
      if (raw is String) {
        activityDataDecode = ActivityData.fromJson(jsonDecode(raw));
      } else if (raw is Map<String, dynamic>) {
        activityDataDecode = ActivityData.fromJson(raw);
      }
    } catch (e) {
