...
class ProductData {
  ...
  factory ProductData.fromJson(Map<String, dynamic> json) {
    return ProductData(
      ...
      productReview: json['reviews'] != null 
          ? (json['reviews'] as List).map((i) => ProductReviewDataModel.fromJson(i)).toList() 
          : (json['product_review'] != null ? (json['product_review'] as List).map((i) => ProductReviewDataModel.fromJson(i)).toList() : null),
    );
  }
