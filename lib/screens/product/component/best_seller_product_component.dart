...
class BestSellerProductComponent extends StatelessWidget {
  ...
  BestSellerProductComponent({required this.bestSellerProductList, this.cartKey});
    ...
    return Column(
      ...
      children: [
        ...
        AnimatedWrap(
          ...
          itemBuilder: (_, index) {
            return ProductItemComponent(productListData: bestSellerProductList[index], cartKey: cartKey);
          },
        ).paddingOnly(top: 0, left: 16, right: 16, bottom: 16)
      ],
    );
  }
}
