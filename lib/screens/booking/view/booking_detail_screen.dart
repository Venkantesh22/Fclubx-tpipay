...
import '../component/cancellation_resone_component.dart';
...
class _BookingDetailScreenState extends State<BookingDetailScreen> {
  ...
  ValueNotifier<String?> bookingId = ValueNotifier(null);

  @override
  void initState() {
    super.initState();
    init();
    bookingId.addListener(() {
        ...
        children: [
          SnapHelperWidget<BookingDetailResponse>(
            ...
            onSuccess: (snap) {
              ...
              final id = snap.data!.bookingId;
              if(id != null && bookingId.value != id) {
                bookingId.value = id;
              }
              return AnimatedScrollView(
                ...
                children: [
                  ///TODO : Check refund amount and show refund details

                  // Show cancellation and refund details for cancelled bookings with refund available
                  // if (snap.data!.status == BookingStatusConst.CANCELLED )
                  //   Column(
                  //     children: [
                  //       CancellationRefundComponent(booking: snap.data!),
                  //     ],
                  //   ),
                  if (snap.data!.cancellationReason != null && snap.data!.cancellationReason!.isNotEmpty && snap.data!.status == BookingStatusConst.CANCELLED)
                    CancellationReasonComponent(booking: snap.data!),
                  ...
                  16.height,
                  ServiceInformationComponent(booking: snap.data!),
                  16.height,
