...
import 'package:frezka/screens/profile/view/invite_and_earn/widget/referral_container.dart';
                  ...
                  children: [
                    ...
                    ListView.separated(
                        itemBuilder: (context, index) {
                          final _referralContainerModel =
                              referralContainersModelList[index];
                          return Referral_Container(
                            referralContainerModel: _referralContainerModel,
                          );
                        },
                        separatorBuilder: (_, __) => 16.height,
                        itemCount: referralContainersModelList.length,
                        shrinkWrap: true,
