class LogisticZoneResponse {
  ...
  LogisticZoneResponse({this.data, this.message, this.status,this.zoneList});
  ...
  factory LogisticZoneResponse.fromJson(Map<String, dynamic> json) {
    return LogisticZoneResponse(
      ...
      status: json['status'],
      zoneList: json['zone_list'] != null ? (json['zone_list'] as List).map((i) => LogisticZoneData.fromJson(i)).toList() : null,
