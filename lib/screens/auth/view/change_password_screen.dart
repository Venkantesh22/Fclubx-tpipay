  ...
  Future<void> changePassword() async {
    if (formKey.currentState!.validate()) {
      ...
      if (getStringAsync(SharedPreferenceConst.USER_PASSWORD) != oldPasswordCont.text) {
        return ShowToast.showError(locale.oldPasswordDoesNotMatchMessage);
      }
          ...
          child: Column(
            ...
            children: [
              ...
              AppTextField(
                ...
                validator: (value) {
                  if (value!.isEmpty) {
                    ...
                    return locale.passwordMustBeBetweenCharacters;
                  }
                  return null;
                },
              ...
              AppTextField(
                ...
                decoration: inputDecoration(context, label: locale.confirmPassword),
              ),
              24.height,
              AppButton(
                text: locale.confirm,
