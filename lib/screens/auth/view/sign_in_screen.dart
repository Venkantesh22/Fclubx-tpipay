...
class _SignInScreenState extends State<SignInScreen> {
  ...
  void init() async {
    ...
    // Use pre-filled values if provided, otherwise use saved values
    if (widget.preFilledEmail != null && widget.preFilledEmail!.isNotEmpty) {
      emailCont.text = widget.preFilledEmail!;
      passwordCont.text = widget.preFilledPassword ?? '';
    } else if (isRemember && !isLoginTypeGoogle && !isLoginTypeApple) {
      emailCont.text = getStringAsync(SharedPreferenceConst.USER_EMAIL,
          defaultValue: await isIqonicProduct
              ? appConfigurationResponseCached?.isDemoLogin == true
                  ? DEFAULT_EMAIL
                  : ""
              : "");
      ...
      emailCont.text = appConfigurationResponseCached?.isDemoLogin == true
          ? DEFAULT_EMAIL
          : "";
      passwordCont.text = appConfigurationResponseCached?.isDemoLogin == true
          ? DEFAULT_PASS
          : "";
    }
  }
  ...
  Future<void> onSignIn() async {
    ...
    if (formKey.currentState!.validate()) {
      ...
      Map request = {
        ...
        CommonKey.fcmToken: SharedPreferenceConst.FCM_TOKEN,
      };

      await loginUser(request).then((value) {
        setValue(SharedPreferenceConst.IS_REMEMBERED, isRemember);
        if (isRemember) {
