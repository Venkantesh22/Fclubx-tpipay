...
class EditProfileScreenState extends State<EditProfileScreen> {
  ...
  Future<void> init() async {
    ...
    String contactNumber = userStore.userContactNumber.validate();
    if (contactNumber.isNotEmpty && contactNumber.contains(' ')) {
      mobileCont.text = contactNumber.formatPhoneNumber(selectedCountry.phoneCode);
    } else {
      mobileCont.text = '';
    }
    ...
    // Set default country if contact number is empty
    if (contactNumber.isEmpty) {
      selectedCountry = defaultCountry();
    } else {
      String raw = contactNumber.validate().trim();
      if (raw.startsWith('+')) {
        ...
        if (m != null) {
          ...
          try {
            Country? fetchedCountry = CountryService().findByPhoneCode(callingCode);
  ...
  Future<void> update() async {
    ...
    updateProfile(
      ...
      ShowToast.showSuccess(locale.profileUpdatedSuccessfully);
    }).catchError((e) {
      appStore.setLoading(false);
