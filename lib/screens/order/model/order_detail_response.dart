...
class TaxDetail {
  ...
  TaxDetail({this.taxName, this.taxType, this.taxValue, this.taxAmount});
...
class OrderListData {
  ...
  DateTime? get deliveringDateTime => DateTime.tryParse(deliveredDate.validate().isNotEmpty ? deliveredDate.validate() : expectedDeliveryDate.validate()) ?? null;

  String get orderingDate => formatDate(orderingDateTime.toString(), format: DateFormatConst.DATE_FORMAT_1, isLocal: true);
  String get deliveringDate => deliveringDateTime != null ? formatDate(deliveringDateTime.toString(), format: DateFormatConst.DATE_FORMAT_1, isLocal: true) : '';
  ...
  factory OrderListData.fromJson(Map<String, dynamic> json) {
    return OrderListData(
      ...
      orderHistory: json['order_history'] != null ? (json['order_history'] as List).map((i) => OrderHistory.fromJson(i)).toList() : [],
      state: json['state'],
...
class OrderHistory {
  ...
  OrderHistory({required this.id, required this.status, required this.dateTime});
