...
class EmployeeData {
  ...
  factory EmployeeData.fromJson(Map<String, dynamic> json) {
    return EmployeeData(
      ...
      gender: json['gender'],
      id: json['id'],
      isBanned: json['is_banned'] != null ? json['is_banned'] == true ? 1 : 0 : 0,
      isManager: json['is_manager'] != null ? json['is_manager'] == true ? 1 : 0 : 0,
      lastName: json['last_name'],
      mobile: json['mobile'],
      playerId: json['player_id'] != null ? json['player_id'] : null,
      showInCalender: json['show_in_calender'] != null ? json['show_in_calender'] == true ? 1 : 0 : 0,
      status: json['status'] != null ? json['status'] == true ? 1 : 0 : 0,
      updatedAt: json['updated_at'],
      expert: json['expert'],
      expertExperience: json['expert_experience'],
  ...
  Map<String, dynamic> toJson() {
    ...
    data['expert_experience'] = this.expertExperience;
