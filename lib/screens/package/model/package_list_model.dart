...
class PackageListData {
  ...
  factory PackageListData.fromJson(Map<String, dynamic> json) {
    return PackageListData(
      ...
      userPackage: json['userPackage'] is List ? List<UserPackage>.from(json['userPackage'].map((x) => UserPackage.fromJson(x))) : [], 
    );
  }
...
class UserPackage {
  ...
  factory UserPackage.fromJson(Map<String, dynamic> json) {
    return UserPackage(
      ...
      purchaseDate: json['purchase_date'] is String ? json['purchase_date'] : "",
    );
  }
