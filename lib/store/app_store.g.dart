...
mixin _$AppStore on _AppStore, Store {
  ...
  late final _$isInternetAvailableAtom =
      Atom(name: '_AppStore.isInternetAvailable', context: context);
  ...
  late final _$onlinePaymentStatusAtom =
      Atom(name: '_AppStore.onlinePaymentStatus', context: context);
  ...
  late final _$setOnlinePaymentStatusAsyncAction =
      AsyncAction('_AppStore.setOnlinePaymentStatus', context: context);
  ...
  void setInternetAvailable(bool val) {
    final _$actionInfo = _$_AppStoreActionController.startAction(
        name: '_AppStore.setInternetAvailable');
    try {
      return super.setInternetAvailable(val);
    } finally {
      _$_AppStoreActionController.endAction(_$actionInfo);
    }
  }
