...
abstract class _BookingRequestStore with Store {
  ...
  @computed
  num get selectedServiceTotalAmount => selectedServiceList.validate().sumByDouble((p0) => isReschedule.validate() ? p0.servicePrice.validate() : p0.defaultPrice.validate()) - finalDiscountCouponAmount.validate();
  ...
  @computed
  num get calculateSelectedServiceTotalAmountWithCouponDiscount => selectedServiceTotalAmount;
  ...
  Map<String, dynamic> toJson({String? dateTime, int? bookingId, String? bookingStatus, bool isUpdate = false, bool isRescheduleBooking = false}) {
    ...
    data['branch_id'] = branchId ?? appStore.branchId;
