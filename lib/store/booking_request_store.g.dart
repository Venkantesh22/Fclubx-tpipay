...
mixin _$BookingRequestStore on _BookingRequestStore, Store {
  ...
  late final _$isLoadingAtom =
      Atom(name: '_BookingRequestStore.isLoading', context: context);
  ...
  late final _$isPackageReclaimAtom =
      Atom(name: '_BookingRequestStore.isPackageReclaim', context: context);

  @override
  bool get isPackageReclaim {
    _$isPackageReclaimAtom.reportRead();
    return super.isPackageReclaim;
  }

  @override
  set isPackageReclaim(bool value) {
    _$isPackageReclaimAtom.reportWrite(value, super.isPackageReclaim, () {
      super.isPackageReclaim = value;
    });
  }
  ...
  late final _$branchIdAtom =
      Atom(name: '_BookingRequestStore.branchId', context: context);
  ...
  @override
  void setBranchIdInRequest(int val) {
    final _$actionInfo = _$_BookingRequestStoreActionController.startAction(
        name: '_BookingRequestStore.setBranchIdInRequest');
    try {
      return super.setBranchIdInRequest(val);
    } finally {
      _$_BookingRequestStoreActionController.endAction(_$actionInfo);
    }
  }
...
isLoading: ${isLoading},
isPackageReclaim: ${isPackageReclaim},
