...
abstract class _ProductStore with Store {
  ...
  @observable
  List<String> selectedPaymentStatusList = ObservableList();
  ...
  @action
  void setSelectedPaymentStatusList(List<String> selectedPaymentStatusListRequest) {
    selectedPaymentStatusList = ObservableList.of(selectedPaymentStatusListRequest);
  }
